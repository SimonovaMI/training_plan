...
def client_plan_for_date(request):
    if request.method == 'POST':
        ...
        for _ in client_plan_for_date_list:
            dict_client_plan = {'start_date_time': _.time_slot.start.strftime("%H:%M"), 'end_date_time': _.time_slot.end.strftime("%H:%M"),
        ...
        for _ in client_in_schedule:
            dict_client_plan = {'start_date_time': _.time_slot.start.strftime("%H:%M"), 'end_date_time': _.time_slot.end.strftime("%H:%M"), 'zone': _.club_zone_id,
